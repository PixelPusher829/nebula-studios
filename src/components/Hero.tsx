		...
		<div ref={containerRef} className="w-full bg-studio-black text-white">
				...
				<div className="relative z-20 text-center px-6 max-w-5xl mx-auto pt-20 pb-24">
					<div ref={textRef} className="space-y-8">
						...
						<p className="text-lg md:text-xl text-studio-light max-w-2xl mx-auto font-sans leading-relaxed">
							Nebula Studios is a collective of artists,
							engineers, and storytellers dedicated to pushing the
				...
				<div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
					<div>
						...
						<p className="text-studio-light text-lg mb-8 leading-relaxed">
							Dive into a shattered world where time is fractured.
							Master the Chrono-Blade and rewrite history in our
							most ambitious Action RPG yet. Winner of "Best Art
							Direction" at the 2024 Game Awards.
						</p>
						<button
							onClick={() => navigate("/games")}
				...
				<div className="max-w-7xl mx-auto px-6">
					<div className="grid md:grid-cols-2 gap-16 items-center">
						...
						<div className="order-1 md:order-2">
							...
							<p className="text-studio-light text-lg mb-8 leading-relaxed">
								We are a team of 200+ dreamers, engineers, and
								artists. From our HQ in San Francisco to our
								remote teams globally, we are united by a single
								mission: to create experiences that matter.
							</p>
							<button
				...
				<div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
					<div className="max-w-2xl">
						...
						<p className="text-xl text-studio-light leading-relaxed mb-8">
							...
							of their craft. Open positions in Engineering, Art,
							Design, and QA.
						</p>
			...
			<section className="py-24 bg-studio-black border-t border-white/5">
				<div className="max-w-4xl mx-auto px-6 text-center">
					...
					<p className="text-studio-light text-lg mb-8 leading-relaxed">
						Looking for a publishing partner? Have a media inquiry?
						Or just want to say hello? We are always looking for the
