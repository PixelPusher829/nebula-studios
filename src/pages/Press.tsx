...
const assets: PressAsset[] = [
	...
	},
	{
		...
		format: "ZIP",
		thumbnail:
			"bg-[url(https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2070&auto=format&fit=crop)] bg-cover",
	},
	{
		id: "4",
		...
		format: "ZIP",
		thumbnail:
			"bg-[url(https://images.unsplash.com/photo-1552820728-8b83bb6b773f?q=80&w=2070&auto=format&fit=crop)] bg-cover",
	},
];
					...
					{assets.map((asset) => (
						...
						>
							...
							>
								...
								{asset.type === "Guide" && (
									<Palette className="text-white w-12 h-12 z-0 group-hover:opacity-20 transition-opacity" />
								)}
							...
							<div className="p-6 relative bg-studio-card z-20">
								<div className="flex items-center gap-2 mb-3">
									{asset.type === "Guide" && (
										<FileText className="w-4 h-4 text-studio-light" />
									)}
									{asset.type === "Logo" && (
										<FileImage className="w-4 h-4 text-studio-light" />
									)}
									{asset.type === "Kit" && (
										<FileImage className="w-4 h-4 text-studio-light" />
									)}
									<span className="text-xs font-bold text-studio-accent uppercase tracking-wider">
