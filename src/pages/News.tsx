				...
				<div className="animate-in fade-in duration-500 bg-studio-black">
						...
						<div className="absolute top-24 left-0 w-full px-6 z-20">
							<div className="max-w-4xl mx-auto">
								<button
									...
									className="inline-flex items-center gap-2 text-white/80 hover:text-white bg-black/40 hover:bg-studio-accent backdrop-blur-md px-4 py-2 rounded-full transition-all font-bold uppercase text-xs tracking-wide"
								>
					...
					<div className="bg-studio-dark py-20 border-t border-white/5">
						<div className="max-w-7xl mx-auto px-6">
							<h3 className="text-2xl font-display font-bold text-white mb-10 border-l-4 border-studio-accent pl-4">
								Related Articles
							</h3>
							<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
								{news
									...
									.map((item) => (
										...
										>
											<div className="rounded-lg overflow-hidden h-48 mb-4 relative shadow-lg">
												...
												<span className="absolute top-2 left-2 bg-studio-black/80 backdrop-blur text-white text-[10px] font-bold px-2 py-1 uppercase rounded tracking-wider">
													{item.category}
												</span>
											</div>
											<h4 className="text-white font-bold font-display text-xl group-hover:text-studio-accent transition-colors leading-tight mb-2">
												{item.title}
											</h4>
											<span className="text-studio-light text-xs font-bold uppercase tracking-wide">
												{item.date}
											</span>
										</div>
									))}
